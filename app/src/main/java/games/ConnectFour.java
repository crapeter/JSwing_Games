...
public class ConnectFour implements ActionListener {
  ...
  public void actionPerformed(ActionEvent e) {
      ...
      if (e.getSource() == buttons[i]) {
        if (player1_turn) {
          if (buttons[i].getText().isEmpty()) {
            ...
            else if (!buttons[i + 10].getText().isEmpty()) {
              buttons[i].setForeground(Color.RED);
              buttons[i].setBackground(Color.RED);
              buttons[i].setText("R");
              player1_turn = false;
    ...
    if (e.getSource() == buttons[4]) {
      if (buttons[4].getText().equals("Reset")) {
        frame.setVisible(false);
        new ConnectFour();
      }
    }
    if (e.getSource() == buttons[5]) {
      if (buttons[5].getText().equals("Menu")) {
        frame.setVisible(false);
        new Game_Selection();
      }
    }
    ...
    for (int i = 59; i > 29; i--) {
      if (!buttons[i].getText().isEmpty()) {
        ...
        if (i % 10 < 3) {
          ...
          else if (buttons[i].getText().equals(buttons[i - 10].getText())
              && buttons[i].getText().equals(buttons[i - 20].getText())
              && buttons[i].getText().equals(buttons[i - 30].getText())) {
            winner(buttons[i].getText(), i, i - 10, i - 20, i - 30);
          }
          // Checking if there are 4 in a row if a right diagonal
          else if (buttons[i].getText().equals(buttons[i - 9].getText())
        ...
        // checking everything
          ...
          else if (buttons[i].getText().equals(buttons[i - 11].getText())
              && buttons[i].getText().equals(buttons[i - 22].getText())
              && buttons[i].getText().equals(buttons[i - 33].getText())) {
        ...
        // checking everything except right diagonals and rows
          ...
          // Checking if there are 4 in a row in the same column
          if (buttons[i].getText().equals(buttons[i - 10].getText())
              && buttons[i].getText().equals(buttons[i - 20].getText())
              && buttons[i].getText().equals(buttons[i - 30].getText())) {
            winner(buttons[i].getText(), i, i - 10, i - 20, i - 30);
          }
