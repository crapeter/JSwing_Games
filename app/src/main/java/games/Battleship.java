...
public class Battleship implements ActionListener {
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    if (e.getSource() == buttons[4]) {
      if (buttons[4].getText().equals("r")) {
        frame.setVisible(false);
        new Battleship();
      }
    }
    if (e.getSource() == buttons[5]) {
      if (buttons[5].getText().equals("e")) {
        frame.setVisible(false);
        new Game_Selection();
      }
    }
      ...
      if (dir == 0) {
        if (shipLen[i] == 5) {
          while (!ship1) {
            // right
            if (shipPos % 10 < 6) {
              if (buttons[shipPos].getText().isEmpty() && buttons[shipPos + 1].getText().isEmpty()
                  && buttons[shipPos + 2].getText().isEmpty() && buttons[shipPos + 3].getText().isEmpty()
                  && buttons[shipPos + 4].getText().isEmpty()) {
        ...
        if (shipLen[i] == 3) {
          while (!ship3) {
            ...
            if (shipPos % 10 < 8) {
              if (buttons[shipPos].getText().isEmpty() && buttons[shipPos + 1].getText().isEmpty()
                  && buttons[shipPos + 2].getText().isEmpty()) {
                for (int j = 0; j < shipLen[i]; j++) {
                  buttons[shipPos + j].setText("s");
                  buttons[shipPos + j].setForeground(Color.blue);
                }
      ...
      // vertical ships
        ...
        if (shipLen[i] == 5) {
          while (!ship1) {
            // right
            if (shipPos / 10 < 6) {
              if (buttons[shipPos].getText().isEmpty() && buttons[shipPos + 10].getText().isEmpty()
                  && buttons[shipPos + 20].getText().isEmpty() && buttons[shipPos + 30].getText().isEmpty()
                  && buttons[shipPos + 40].getText().isEmpty()) {
        ...
        if (shipLen[i] == 3) {
          while (!ship3) {
            ...
            if (shipPos / 10 < 8) {
              if (buttons[shipPos].getText().isEmpty() && buttons[shipPos + 10].getText().isEmpty()
                  && buttons[shipPos + 20].getText().isEmpty()) {
                for (int j = 0; j < shipLen[i] * 10; j += 10) {
                  buttons[shipPos + j].setText("s");
                  buttons[shipPos + j].setForeground(Color.blue);
                }
